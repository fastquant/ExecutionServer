...
/**
 * Fix implementation for raptor connections.
 * 
 * @author Sylvio Azevedo
 */
public class Fix44Raptor extends AbstractFixConnection {
    ...
    public void processRequest(ExecutionOrder order) throws SessionNotFound {        
        ...
        switch (order.getReqType()) {
            ...
            case RequestTypes.REQUEST_NEW_ORDER:
                ...
                message.set(new SecurityIDSource(SecurityIDSource.EXCHANGE_SYMBOL));                
                ...
                noPartyIDsGroup.set(new PartyID(order.getBroker()));
            ...
            case RequestTypes.REQUEST_REPLACE:
                ...
                replaceMessage.set(new SecurityIDSource(SecurityIDSource.EXCHANGE_SYMBOL));
                ...
                //replaceMessage.set(new Account(order.account));
            ...
            case RequestTypes.REQUEST_CANCEL:
                ...
                cancelMessage.set(new SecurityIDSource(SecurityIDSource.EXCHANGE_SYMBOL));
